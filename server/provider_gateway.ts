...
export type GatewayModelOptions = {
  apiKey: string;
  model: string;
...
/** Create a LanguageModelV1 that routes through the AssemblyAI LLM gateway. */
export function createGatewayModel(opts: GatewayModelOptions): LanguageModelV1 {
